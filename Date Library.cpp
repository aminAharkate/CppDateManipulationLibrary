...
//
//	cout << "u can check the funtion and manipulate the date as u want " << endl;
//	cout << "r example u can increase or decrease date by days, months or years " << endl;
//	cout << "or calculate the difference between 2 dates in days, months or years " << endl;
//    
// 
//
//
